...
namespace ChungToi.Game
{
	...
	public sealed class MainMenuController : MonoBehaviour
	{
		...
		private static readonly Color BgColor = new(0.10f, 0.10f, 0.12f, 1f);
		private static readonly Color PanelColor = new(0.16f, 0.16f, 0.20f, 1f);
		private static readonly Color BtnIdle = new(0.30f, 0.30f, 0.35f, 1f);
		private static readonly Color BtnSelected = new(0.20f, 0.55f, 0.95f, 1f);
		private static readonly Color BtnHover = new(0.40f, 0.40f, 0.50f, 1f);
		private static readonly Color BtnPressed = new(0.15f, 0.40f, 0.75f, 1f);
		private static readonly Color StartIdle = new(0.20f, 0.65f, 0.30f, 1f);
		private static readonly Color StartHover = new(0.30f, 0.80f, 0.40f, 1f);
		private static readonly Color TextColor = Color.white;
		private static readonly Color SubduedText = new(0.75f, 0.75f, 0.80f, 1f);
